...
def get_landmark(base64_str, predictor):
    """get landmark with dlib
    :return: np.array shape=(68, 2)
    """
    detector = dlib.get_frontal_face_detector()
    #img=base64code to image
    ...
    # Use the detector on the NumPy array
...
def align_face(base64_code, predictor):
    """
    :param filepath: str
    :return: PIL Image
    """

    lm = get_landmark(base64_code, predictor)
    ...
    qsize = np.hypot(*x) * 2
    #image = base 64code to image 
    # read image
    img = base64_to_image(base64_code).convert("RGB")
